	...
	public void guardaPrimerJsonDB(){
		new AsyncTask<Void, Void, Void>(){
			...
			protected void onPostExecute(Void result) {
				if(bandera){
//					Toast.makeText(getActivity().getApplicationContext(),"Listo verifica la DB Events!", Toast.LENGTH_LONG).show();					
				}else{
...
//				readTableEvents_fillListEvent();
				...
				"&radio=10" +
				"&categoria="+sharedPreferencesHelper.obtieneCategoriasPreferences()+"" +
