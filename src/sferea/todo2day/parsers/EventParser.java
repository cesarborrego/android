...
public class EventParser {
	...
	public static ArrayList<EventoObjeto> parseJsonListaEventos(String json)
	...
	public static EventoObjeto parseJsonEvento(JSONObject json)
		...
		evento.setTipoBoleto(TipoBoletoParser.parseJsonTipoBoletos(json.getJSONObject(KEY_TICKET_TYPE)));
